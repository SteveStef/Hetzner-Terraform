...
- `health-check.sh` - Dynamic health monitoring script
- `backup-script.sh` - Database backup with MinIO (if backup enabled)
- `setup-backup-timer.sh` - Systemd timer configuration (if backup enabled)
